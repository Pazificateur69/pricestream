...
class TestBinanceClient:
    ...
    def test_fetch_parses_response(self):
        with patch(
            "apps.pricing.exchanges.httpx.get",
    ...
    def test_fetch_returns_none_on_error(self):
        with patch("apps.pricing.exchanges.httpx.get", side_effect=Exception("boom")):
...
class TestKrakenClient:
    ...
    def test_fetch_parses_response(self):
        ...
        with patch("apps.pricing.exchanges.httpx.get", return_value=_fake_response(payload)):
